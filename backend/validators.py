...
def validate_positive(value):
    if value > 0:
        ...
        raise ValidationError('Musbat butun son kiriting')
...
def validate_sponsorship_money_on_update(instance, validated_data):
    ...
    if money <= sponsor_left_money:
        if student_gained_money + money <= student.contract_money:
        ...
        raise ValidationError({'money': "Homiyda buncha pul yo'q"})
